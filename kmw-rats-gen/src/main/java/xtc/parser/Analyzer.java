 ...
 * qualified and unqualified names.</li>
 *
 * <li>Methods to {@link #isTopLevel(Module) test for} and {@link
 * #topLevel() access} the top-level (or root) module of a grammar.</li>
 *
 ...
 * not update the current grammar.</li>
 *
 ...
 * processing productions from several modules.</li>
 *
 * <li>A method to uniquely {@link #uniquify()} the names of all
 * productions across all modules.</li>
 *
 ...
 * these sets should be fully qualified.</li>
 *
 ...
 * through {@link #remove(FullProduction)}.</li>
 *
 ...
 * #stripChoices(OrderedChoice) strip} only ordered choices.</li>
 *
 * <li>A method to {@link #copy(Element) copy} an element.</li>
 *
 ...
 * #joinTerminals(Sequence,Element)}.</li>
 *
 ...
 * #joinPrefixes(Sequence,Element)}.</li>
 *
 * <li>A method to {@link #matchingText(Element) get the text} of an
 * element.</li>
 *
 * <li>A method to determine whether an element {@link
 * #restrictsInput(Element) restricts the input}.</li>
 *
 * <li>A method to determine whether an element {@link
 * #consumesInput(Element) consumes the input}.</li>
 *
 * <li>A method to determine whether an element {@link
 * #matchesEmpty(Element) matches the empty input}.</li>
 *
 * <li>A method to determine whether an element {@link
 ...
 * sets the semantic value to <code>null</code>.</li>
 *
 * <li>A method to determine whether an element's list value {@link
 * #mayBeNull(Element) may be null}.</li>
 *
 * <li>A method to {@link #type(Element) type} an element.</li>
 *
 * </ul>
 *
